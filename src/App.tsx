...
function MobileNavigation({ isExpanded }: { isExpanded: boolean }) {
  return (
    <div
      className={clsx(
        "md:hidden block absolute top-16 left-0 w-full h-screen-min-16 p-6 transition-transform duration-300 ease-in-out bg-white",
        isExpanded ? "translate-x-0" : "translate-x-full"
      )}
    >
      <nav className='rounded-md' aria-label='Navigation Menu'>
